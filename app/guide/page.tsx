                ...
                <div className="space-y-24 animate-in fade-in slide-in-from-bottom-4 duration-1000 delay-200">
                    ...
                    <section className="relative overflow-hidden">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
                            <div className="space-y-4">
                                <h3 className="text-[#FF4655] font-black uppercase tracking-widest text-xs">Typing is Tactical Execution</h3>
                    ...
                    <section>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
                            {[
                                { title: "Resonance Core", desc: "Bottom-center bar. Shows current ability charge % and cooldown state.", icon: "⚡" },
                                { title: "Uplink Metrics", desc: "Top-left readout. Real-time WPM, Accuracy, and Grid Progress.", icon: "📊" },
                                { title: "Network Status", desc: "The progress bars behind your text track your position relative to other operatives.", icon: "🌐" }
                            ].map((item, i) => (
                    ...
                    <section>
                        ...
                        <div className="space-y-12">
                            <p className="text-white/70 leading-relaxed italic">
                                Each operative possesses a <b className="text-white underline">Passive Protocol</b> and a signature <b className="text-white underline">Active Ability</b>. Execute your active ability with <kbd className="bg-white/10 px-2 py-1 rounded text-[#FF4655] font-black border border-white/10">TAB</kbd> once resonance reaches 100%.
                            </p>
                    ...
                    <section className="bg-[#FF4655]/5 border-y border-[#FF4655]/20 py-12 -mx-8 px-8">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                            <div className="col-span-1 md:col-span-2 space-y-8">
                                <div>
                                    <h3 className="text-xs font-black uppercase tracking-[0.3em] text-[#FF4655] mb-4 underline">Resonance_Charge_Formula</h3>
                                    ...
                                    <div className="grid grid-cols-2 gap-4 mt-6">
                                        ...
                                        <div className="space-y-1">
                                            <span className="text-[10px] text-[#FF4655]/60 uppercase font-black">Integrity Weight</span>
                                            <div className="h-1 bg-white/10 w-full rounded-full overflow-hidden">
