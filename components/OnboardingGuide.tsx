...
export default function OnboardingGuide({
    ...
    return (
        <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/60 backdrop-blur-sm animate-in fade-in duration-500">
            <div className="max-w-md w-full bg-[#0d0b09] border-2 border-[#f5a623] p-8 shadow-[0_0_50px_rgba(245,166,35,0.2)] relative overflow-hidden group">
                ...
                <div className="relative z-10">
                    <div className="absolute top-0 right-0 z-50">
                        <button
                            onClick={onComplete}
                            className="text-[10px] font-black uppercase tracking-widest text-white/40 hover:text-[#f5a623] transition-all bg-white/5 border border-white/10 px-3 py-1 backdrop-blur-sm rounded-sm"
                        >
                            [ SKIP_BRIEFING ]
                        </button>
                    </div>
