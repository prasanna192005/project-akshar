...
export const AGENTS: Record<AgentType, Agent> = {
    ZEPHYR: {
        ...
        active: 'SLIPSTREAM — skips cursor forward 5 words instantly.',
        abilityKey: 'TAB',
    ...
    PYRA: {
        ...
        active: 'REWRITE — applies burning blur overlay on ONE opponent\'s screen for 5s.',
        abilityKey: 'TAB',
    ...
    SAGE: {
        ...
        active: 'FORETOLD — freezes your own progress bar so it can\'t be targeted by effects for 4s.',
        abilityKey: 'TAB',
    ...
    VIPER: {
        ...
        active: 'COMPOUND — scrambles 3 random upcoming words on ONE opponent\'s screen.',
        abilityKey: 'TAB',
        chargeRateModifier: 1.0,
        cooldown: 14,
        duration: 4,
    ...
    OMEN: {
        ...
        active: 'ABSENCE — hides the next 10 words from ONE opponent\'s view for 4s.',
        abilityKey: 'TAB',
        chargeRateModifier: 1.0,
        cooldown: 13,
        duration: 4,
    ...
    BREACH: {
        ...
        active: 'FAULT LINE — flashes ONE opponent\'s screen bright white for 2.5s.',
        abilityKey: 'TAB',
    ...
    REYNA: {
        ...
        active: 'DEVOUR — for 8s, every typo the target makes moves their progress BACKWARDS by one word.',
        abilityKey: 'TAB',
    ...
    KILLJOY: {
        ...
        active: 'LAST TUESDAY — locks ONE opponent\'s keyboard input for 2s.',
        abilityKey: 'TAB',
